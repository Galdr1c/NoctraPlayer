...
public sealed class StubEpgService : IEpgService
{
    ...
    public Task<int> LoadEpgAsync(string epgUrl, bool isPrimary, List<Channel>? channelsForMapping = null, int daysAhead = 1, IProgress<EpgProgressInfo>? progress = null, bool clearBeforeSave = false)
        => Task.FromResult(0);
