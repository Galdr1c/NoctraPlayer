...
public partial class PinEntryView : UserControl
{
    ...
    private PinEntryViewModel? _previousViewModel;
    ...
    protected override void OnDataContextChanged(EventArgs e)
    {
        if (_previousViewModel is not null)
            _previousViewModel.PropertyChanged -= ViewModel_OnPropertyChanged;

        _previousViewModel = DataContext as PinEntryViewModel;
        if (_previousViewModel is not null)
            _previousViewModel.PropertyChanged += ViewModel_OnPropertyChanged;
    ...
    {
        if (DataContext is not PinEntryViewModel viewModel)
        {
            return;
        }
