...
/// (kodda sabit tutulmaz). Zorunlu: NOCTRA_PACKAGE_NAME,
/// NOCTRA_SUBSCRIPTION_PRODUCT_IDS, NOCTRA_LIFETIME_PRODUCT_IDS.
///
/// Backend stateless'tir: entitlement verisi tutulmaz, RTDN yoktur. Google
/// Play Developer API erişimi Cloud Run service identity (ADC) üzerinden
/// yapılır — service account private key'i env'de tutulmaz.
/// </summary>
