...
namespace Noctra.Tests
{
    ...
    internal sealed class FakeMetadataService : IMetadataService
    {
        ...
        public Task<ChannelMetadata?> FetchMetadataAsync(string searchQuery, ChannelType? type = null, string languageCode = "tr-TR", CancellationToken cancellationToken = default) => Task.FromResult<ChannelMetadata?>(null);
        public Task<List<string>> GetGenresAsync(List<int> genreIds, string languageCode = "tr-TR", CancellationToken cancellationToken = default) => Task.FromResult(new List<string>());
        public void ClearCache() { }
        public Task<TmdbDetail?> FetchSeriesDetailsAsync(int tmdbId, string languageCode = "tr-TR", CancellationToken cancellationToken = default) => Task.FromResult<TmdbDetail?>(null);
        public Task<TmdbSeasonDetail?> FetchSeasonDetailsAsync(int tmdbId, int seasonNumber, string languageCode = "tr-TR", CancellationToken cancellationToken = default) => Task.FromResult<TmdbSeasonDetail?>(null);
        public Task<ChannelMetadata?> SearchSeriesAsync(string searchQuery, string languageCode = "tr-TR", CancellationToken cancellationToken = default) => Task.FromResult<ChannelMetadata?>(null);
