...
namespace Noctra.Tests
{
    ...
    internal sealed class FakeEpgService : IEpgService
    {
        ...
        public Task<int> LoadEpgAsync(string epgUrl, bool isPrimary, List<Channel>? channelsForMapping = null, int daysAhead = 1, IProgress<EpgProgressInfo>? progress = null, bool clearBeforeSave = false, IDictionary<string, string>? headers = null, string? preferredLanguageCode = null) => Task.FromResult(0);
    ...
    internal sealed class FakeMediaService : IMediaService
    {
        ...
        public void RaiseAggregationStarted(int playlistId) => OnAggregationStarted?.Invoke(playlistId);
