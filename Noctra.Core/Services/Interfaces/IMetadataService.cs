...
public interface IMetadataService
{
    ...
    /// <returns>Metadata if found, null otherwise</returns>
        Task<ChannelMetadata?> FetchMetadataAsync(string searchQuery, ChannelType? type = null, string? languageCode = null, CancellationToken cancellationToken = default);
    ...
    /// <returns>List of genre names</returns>
        Task<List<string>> GetGenresAsync(List<int> genreIds, string? languageCode = null, CancellationToken cancellationToken = default);
    ...
    /// </summary>
        Task<TmdbDetail?> FetchSeriesDetailsAsync(int tmdbId, string? languageCode = null, CancellationToken cancellationToken = default);

    /// <summary>
    /// Fetches a specific season's details including all episode overviews and thumbnails
    /// </summary>
        Task<TmdbSeasonDetail?> FetchSeasonDetailsAsync(int tmdbId, int seasonNumber, string? languageCode = null, CancellationToken cancellationToken = default);
    ...
    /// </summary>
        Task<ChannelMetadata?> SearchSeriesAsync(string searchQuery, string? languageCode = null, CancellationToken cancellationToken = default);
